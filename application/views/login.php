                        ...
                        <div class="card-body" style="margin: 14%;">
                          ...
                          <div class="col-auto">
                            ...
                            <div class="input-group mb-2">
                              ...
                              <input type="text" class="form-control is-invalid" id="user" placeholder="">
                            </div>
                          </div>
                          <div class="col-auto">
                            ...
                            <div class="input-group mb-2">
                              ...
                              <input type="password" class="form-control is-invalid" id="pass" placeholder="">
                            </div>
                          </div>
                          <button type="button" style="width: 93.5%;" class="btn btn-primary mb-2">Next</button>
                         </center>
                        </div>
                      </div>
                    </div>
